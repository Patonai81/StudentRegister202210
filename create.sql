...
create table student (id int8 not null, birth_date date not null, external_id int4 not null, name varchar(255) not null, semester int4 not null, used_free_semesters int4 not null, image_id int8, primary key (id));
create table student_aud (id int8 not null, rev int4 not null, revtype int2, birth_date date, external_id int4, name varchar(255), semester int4, used_free_semesters int4, image_id int8, primary key (id, rev));
